...
@Slf4j
public class FetchMegazordUseCaseViaCompletableFutureImpl implements FetchMegazordUseCase {
    ...
    public static void main(String[] args) {
        ...
        var fetchMegazordUseCase = new FetchMegazordUseCaseViaCompletableFutureImpl(powerRangerClient);
